...
class Root(Action):
    ...
    def _init_grammar(self):
        # TODO: should add Root grammar to this
        self.grammar_dict = {
            0: 'Root Sel From Group Sup Filter',
            1: 'Root Sel From Group Filter Order',
            2: 'Root Sel From Group Sup',
            3: 'Root Sel From Group Filter',
            4: 'Root Sel From Group Order',
            5: 'Root Sel From Group',
        }
        self.production_id = {}
        for id_x, value in enumerate(self.grammar_dict.values()):
            self.production_id[value] = id_x
