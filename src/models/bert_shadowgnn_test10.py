...
class Shadowgnn(BasicModel):
    ...
    def __init__(self, args, grammar):
        ...
        for l in range(self.layer_num):
            ...
            self.schema_rgcn.append(HeteroRelGCN(etypes, args.hidden_size, args.hidden_size, 2))

            self.shadow_rgcn.append(HeteroRelGCN(etypes, args.hidden_size, args.hidden_size, 2))
