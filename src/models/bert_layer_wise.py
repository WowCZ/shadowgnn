...
class IRNet(BasicModel):
    ...
    def __init__(self, args, grammar):
        ...
        # self.src_shadow_cat_linear = []
        # self.shadow_src_cat_linear = []
        # self.schema_src_cat_linear = []
        ...
        if args.cuda:
            for l in range(self.layer_num):
                ...
                # self.src_shadow_cat_linear[l] = self.src_shadow_cat_linear[l].cuda()
                # self.shadow_src_cat_linear[l] = self.shadow_src_cat_linear[l].cuda()
                # self.schema_src_cat_linear[l] = self.schema_src_cat_linear[l].cuda()
