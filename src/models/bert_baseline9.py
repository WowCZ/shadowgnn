...
class Shadowgnn(BasicModel):
    ...
    def one_layer_see_schema(self, src_embedding, table_embedding, column_embedding, schema_graph, schema_linking_q,
                             layer_id):
        ...
        return src_schema_ctx, table_schema_encoding, column_schema_encoding, src_schema_att_prob
    ...
    def sent_see_schema(self, batch, src_encodings, table_embeddings, schema_embeddings):
        ...
        for bi, (ss_len, t_len, c_len) in enumerate(zip(src_sents_len, table_len, table_col_len)):
            ...
            for l_id in range(self.layer_num):
                src_encoding, table_encoding, column_encoding, src_schema_att_prob = \
                    self.one_layer_see_schema(src_encoding, table_encoding, column_encoding,
                                              schema_graph, schema_link_embed, layer_id=l_id)
